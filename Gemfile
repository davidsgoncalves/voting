...
gem 'rails', '~> 5.0.5' # Bundle edge Rails instead: gem 'rails', github: 'rails/rails'
...
gem 'simple_enum'           # Simple enum

# Infrastucture

# Server environment
gem 'puma', '~> 3.0'      # Use Puma as the app server
gem 'rack-cors'           # The CORS spec allows web applications to make cross domain AJAX
...
group :development, :test do
  ...
  gem 'rspec-rails', '~> 3.6'       # Test suite for rails
end

group :development do
  gem 'annotate'                            # Database annotate for models and tests
  ...
  gem 'better_errors'                       # better errors debug
